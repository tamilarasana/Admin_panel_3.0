                ...
                <table id="category" class="table table-hover">
                        ...
                        @foreach($categorys as $item)
                            <tr>
                                ...
                                {{-- <a href="{{url('category-delete/'.$item->id)}}" onclick="return confirm('Are you sure?')"  class="btn-sm btn-danger"> <i class="fa fa-trash"></i></a> --}}
...
<div class="modal modal-danger fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('category.delete', 'id') }}" method="get">
                @csrf
                @method('get')
